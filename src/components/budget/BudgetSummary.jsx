        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-slate-900 currency-large">{formatCurrency(totalBudgeted, 'EUR', true, false)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-slate-900 currency-large">{formatCurrency(totalSpent, 'EUR', true, false)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
                ...
                <p className={`text-2xl font-bold currency-large ${isOverBudget ? 'text-red-600' : 'text-emerald-600'}`}>{formatCurrency(totalRemaining, 'EUR', true, false)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
